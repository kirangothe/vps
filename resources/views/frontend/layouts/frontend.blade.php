                ...
                <div class="pm-main-menu-item float-right">
                    ...
                    <nav class="pm-main-navigation float-right clearfix ul-li">
                        <ul id="main-nav" class="navbar-nav text-capitalize clearfix">
                            <li><a href="{{route('check-in.pre.registered')}}">{{__('frontend.have_appoinment')}}</a></li>
                            <li><a href="{{route('check-in.return')}}">{{__('frontend.been_here_before')}}</a> </li>
                            @if(auth()->user())
                            <li>
                            ...
                            <li class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" style="border-bottom:none !important; width:100px !important">
                                    @if(!blank($language))
                                    @foreach($language as $lang )
                                    <a href="{{ route('admin.lang.index',$lang->code) }}" class="language dropdown-item has-icon text-center" style="min-width:100px !important">
